@extends('layouts.app')
@section('title', 'Daftar Permintaan - Admin Pusat')
@section('header', 'Daftar Permintaan Barang')

@section('content')
<div class="max-w-6xl mx-auto">
<div class="flex justify-between items-center mb-6">
            <h1 class="text-3xl font-bold text-gray-800">Daftar Permintaan Barang</h1>
                ...
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-6 py-4 text-sm text-gray-800 font-medium">{{ $p->cabang->nama ?? 'Cabang Tidak Diketahui' }}</td>
                            <td class="px-6 py-4 text-sm text-gray-600">{{ Str::limit($p->catatan, 30) }}</td>
                            ...
                            <td class="px-6 py-4 text-sm text-center">
                                <a href="{{ route('adminPusat.permintaan.detail', $p->id) }}" class="bg-indigo-50 text-indigo-600 hover:bg-indigo-100 px-3 py-1.5 rounded-md font-medium transition">Detail & Proses</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
